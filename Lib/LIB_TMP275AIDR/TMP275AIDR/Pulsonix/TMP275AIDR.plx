...
//322856/1553794/2.50/8/4/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "TMP275AIDR" (originalName "TMP275AIDR")
	...
	(compDef "TMP275AIDR" (originalName "TMP275AIDR") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "7" (pinName "A0") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "A1") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "A2") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TMP275AIDR"))
		...
		(attr "Mouser Part Number" "595-TMP275AIDR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/TMP275AIDR?qs=7kv20MEVUlg8zTOvEWj%252BhA%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "TMP275AIDR")
		(attr "Description" "+/-0.5C Temperature Sensor with I2C/SMBus Interface in Industry Std LM75 Form Factor & Pinout")
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/TMP275")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "TMP275AIDR.stp")
